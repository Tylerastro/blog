export default function Home() {
  return (
    <main className="min-h-screen grid grid-rows-[auto_1fr_1fr] md:grid-rows-[auto_1fr] md:grid-cols-2 gap-4 p-4 md:p-6">
      ...
      <div className="md:col-span-2 flex items-center justify-center bg-gradient-to-r from-blue-50 to-purple-50 dark:from-gray-900 dark:to-gray-800 rounded-lg p-8">
        <div className="text-center max-w-4xl">
          <h1 className="text-4xl md:text-6xl font-bold text-foreground mb-6">
            Welcome to My Digital Space
          </h1>
          <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed">
            A place where technology meets creativity. Explore my projects, read
            my thoughts, and let's build something amazing together.
          </p>
        </div>
      </div>
